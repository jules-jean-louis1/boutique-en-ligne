            ...
            .then(data => {
                ...
                if (data.status == 'success') {
                    ...
                    <div class="flex flex-col items-center justify-center space-y-2 w-full border-[1px] border-[#a8b3cf33] rounded-[14px] xl:w-8/12 p-4 mb-2">
                        ...
                        <div id="reponseAvis-${avis.id_avis}"></div>
                    </div>
                    `;
                            for (let reply of data.reply_avis) {
                                if (reply.avis_parent_id == avis.id_avis) {
                                    ...
                                    <div class="flex flex-col w-full ml-6 p-4 mr-2">
                                        <div class="flex flex-row justify-between bg-[#0e1217] hover:bg-[#21262D] w-full border-l-2 border-[#a8b3cf33]">
                                            ...
                                            <div class="flex flex-row">
                                                <span class="text-[#a8b3cf]"><b class="bg-[#A87EE6AE] p-0.5 w-fit rounded-lg text-white">@${avis.login_users}</b> ${reply.content_comment}</span>
                                            </div>
                                            </div>
                                    ...
                                    <div id="reponseComment"  class="ml-4"></div>
                                    `;
                                }
                            }
                        }
                        ...
                        for (let reply of data.reply_avis) {
                            for (let reply2 of data.reply_avis) {
                                if (reply2.comment_parent_id === reply.id_comment) {
                                    console.log('Réponse trouvée !');
                                    console.log(reply2.content_comment);
                                    ...
                                    <div class="flex flex-col w-full ml-6 p-4 mr-2">
                                        <div class="flex flex-row justify-between bg-[#0e1217] hover:bg-[#21262D] w-full border-l-2 border-[#a8b3cf33]">
                                            ...
                                            <div class="flex flex-row">
                                                <span class="text-[#a8b3cf]"><b class="bg-[#A87EE6AE] p-0.5 w-fit rounded-lg text-white">@${avis.login_users}</b> ${reply2.content_comment}</span>
                                            </div>
                                            </div>
                                            <div class="flex flex-row justify-between">
