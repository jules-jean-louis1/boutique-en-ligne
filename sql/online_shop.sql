...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 05 juin 2023 à 13:23
...
INSERT INTO `avis_client` (`id_avis`, `produit_id`, `titre_avis`, `commentaire_avis`, `note_avis`, `created_at`, `update_at`, `users_id`) VALUES
(1, 1, 'Test', 'Test', 4, '2023-04-19 14:25:23', NULL, 1),
(2, 1, 'ttt', 'rrrR', 3, '2023-04-19 14:38:32', NULL, 1),
(3, 1, 'Avis3', 'Corporis ad aperiam possimus similique rem. Dolore quae molestiae eos sit molestiae voluptatem. Ad perspiciatis aliquam.', 4, '2023-04-19 15:26:56', '2023-04-19 18:12:40', 1),
(4, 1, 'Lorem', 'Corporis ad aperiam possimus similique rem. Dolore quae molestiae eos sit molestiae voluptatem. Ad perspiciatis aliquam quia.', 1, '2023-04-19 15:34:25', NULL, 3),
(5, 9, 'Test', 'Test', 4, '2023-04-27 14:45:47', NULL, 5),
(6, 9, 'test02', 'Try', 2, '2023-04-27 14:47:11', NULL, 5),
(7, 9, 'test 04', 'F', 2, '2023-04-27 14:47:59', NULL, 5),
(8, 2, 'Harum quisquam', 'Harum quisquam officia eligendi nam eos qui illum aut. Omnis accusantium debitis nihil temporibus consequatur velit. Laboriosam non explicabo debitis. Est autem omnis nostrum soluta corrupti qui id reiciendis. Repudiandae quia natus est et', 3, '2023-04-27 14:49:32', NULL, 5);
...
(10, '0.00', 'active', '2023-05-09 18:18:27', '2023-05-09 18:18:30', 1),
...
(1, 'Jules', 'Jean', 'Marseille', '10000', '4 montée Nowhere', '', 'France', 1),
(2, '', '', '', '', '', '', '', 2),
...
(7, '2023-05-09 12:03:40', '39.98', 'En cours', 1),
(6, '2023-04-27 14:57:10', '173.97', 'Expédiée', 5),
...
(1, 'Jules', 'jules@gmail.com', '$2y$10$D3mudbEmz/P05lHCPguMeeQ0PUIWaIP0fNddnW3NmOow4lPJ57H0y', 'administrateur', 'unnamed-2.png', '2023-04-04 11:47:07', '2023-05-09 12:05:10'),
...
(7, 'Patrick', 'lionel2@gmail.com', '$2y$10$6B..8XocN3EWq7Qza/RuVuWe7XtrQ9IQKklaMES6um5TQQEwbhjeC', 'client', 'default_avatar.png', '2023-05-08 20:06:42', NULL),
(8, 'Patrick2', 'lionel3@gmail.com', '$2y$10$zOao2F3lo.O.fElCE2b28.pnhiLxR9KaUIpqHeeITe7p7Ho7CVSO6', 'client', 'default_avatar.png', '2023-05-08 20:06:55', NULL),
...
(15, 'User7', 'user7@gmail.com', '$2y$10$/yDBVr/0bWoy3.K0i76O4.xRTWTfEODwTVJ5nEX6/jGqx7YKBwUWe', 'client', 'default_avatar.png', '2023-05-08 20:10:45', NULL);
COMMIT;
